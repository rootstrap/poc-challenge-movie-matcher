...
class MovieDetailActivity : Activity() {
    ...
    private val fakeList = listOf(
        com.moviematcher.RecommendedBy(name = "Juan Perez", imageUrl = "", isFriend = false),
        com.moviematcher.RecommendedBy(name = "Maria Fernandez", imageUrl = "", isFriend = false),
        com.moviematcher.RecommendedBy(name = "Martín Baez", imageUrl = "", isFriend = false),
        com.moviematcher.RecommendedBy(name = "Lucía Martinez", imageUrl = "", isFriend = false),
    )
    ...
    private fun setRecommendedByList() {
        with(binding.recycler) {
            ...
            adapter = com.moviematcher.RecommendedByAdapter(fakeList).also {
